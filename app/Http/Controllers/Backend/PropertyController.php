...
class PropertyController extends Controller
{
    ...
    public function PropertyEdit($id)
    {
        ...
        return view('backend.property.edit', compact('property', 'property_types', 'amenities', 'agents', 'multiImage', 'facilities','amenities_id'));
    }
    //PropertyUpdate
    ...
    //PropertyThambnail
    public function PropertyThambnailUpdate($id)
    {
        $property = Property::findOrFail($id);
    ...
    //PropertyMultiImage
    public function PropertyMultiImage(Request $request)
    {
    ...
    public function PropertyMultiImageAdd(Request $request)
    {
    ...
    public function PropertyShow($id)
    {
        ...
        $multiImage  = MultiImageProperty::where('property_id', $id)->get();
        $facilities = FacilityProperty::where('property_id', $id)->get();
        return view('backend.property.show', compact('property', 'property_types', 'amenities', 'agents', 'multiImage', 'facilities','amenities_id'));
    }
    //PropertyInactive
    public function PropertyInactive(Request $request)
    {
        $id = $request->id;
    ...
    //PropertyActive
    public function PropertyActive(Request $request)
    {
        $id = $request->id;
