                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('agent.property.update', $property->id) }}" id="myForm"
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="street_address2" class="form-control"
                                                    value="{{ $property->street_address2 }}">
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('agent.property.thambnail.update', $property->id) }}" id="myForm" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('agent.property.multi_image.update') }}" id="myForm" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            @foreach ($multiImage as $key => $img)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('agent.property.multi_image.delete', $img->id) }}" class="btn btn-danger" id="delete">Delete
                                                        </a>
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            <form method="post" action="{{ route('agent.property.multi_image.store') }}" id="myForm" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('agent.property.facility.update') }}" id="myForm" enctype="multipart/form-data">
                                @csrf
