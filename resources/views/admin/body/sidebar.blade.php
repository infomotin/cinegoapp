<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item nav-category">CineGoHouse</li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#emails" role="button"
                    aria-expanded="false" aria-controls="emails">
                    <i class="link-icon" data-feather="mail"></i>
                    <span class="link-title">Property Type Management</span>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="property">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('backend.property.index') }}" class="nav-link">All Properties</a>
                        </li>
                        <li class="nav-item">
            ...
            <li class="nav-item">
                    ...
                    <div class="collapse" id="property">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="{{ route('admin.backend.package.history') }}" class="nav-link">Package Report</a>
                            </li>
                            <li class="nav-item">
