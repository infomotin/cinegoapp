...
@section('content')
    ...
    <div class="page-content">
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">PoliceStation List </a></li>
                <li class="breadcrumb-item active" aria-current="page">Add PoliceStation</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">All PoliceStation</h6>
                        <div
